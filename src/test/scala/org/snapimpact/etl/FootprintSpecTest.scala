...
/*
 * <<<<<<< HEAD:src/test/scala/org/snapimpact/etl/FootprintSpecTest.scala
           ...
           "Parse Sex Restrictions in Volunteer Opportunities" in
                    {
                      def parseSex(sexstr: String) =
                        {
                          VolunteerOpportunity.fromXML(<VolunteerOpportunity>
                            <volunteerOpportunityID>2002</volunteerOpportunityID> <sponsoringOrganizationIDs>
                              <sponsoringOrganizationID>2</sponsoringOrganizationID>
...
// >>>>>>> Got more Lucene related stuffs workin':src/test/scala/org/snapimpact/etl/FootprintSpecTest.scala
}
